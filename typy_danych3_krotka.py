...
tupla_names_new = ("Radek", "Tomek", "Asia", "Zbyszek", "Marek")
print(type(tupla_names_new))  # <class 'tuple'>
print(tupla_names_new)  # ('Radek', 'Tomek', 'Asia', 'Zbyszek', 'Marek')
...
print(tupla_names_new.count("Tomek"))  # 1
print(tupla_names_new.index("Tomek"))  # 1
print(sorted(tupla_names_new))  # sortowanie tupli daje liste ['Asia', 'Marek', 'Radek', 'Tomek', 'Zbyszek']
...
imie, *imie2, imie3 = tupla_names_new
